...
class User(UserMixin, BaseModel):
    ...
    # A user is not considered to be on a trial merely because they registered.
    # The value becomes "trial" only when a trial is actually started.
    account_type = db.Column(db.String(20), default="pending", nullable=False)

    onboarding_completed = db.Column(db.Boolean, default=False, nullable=False)
    pqi_enabled = db.Column(db.Boolean, default=False, nullable=False)
    ...
    trials = db.relationship(
        ...
        passive_deletes=True,
        lazy="select",
        order_by="Trial.start_date.desc()",
    )
